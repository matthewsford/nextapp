...
namespace MatthewFordUs.NextApp.WebApi.UnitTests.Controllers {
  public class StudentsControllerTest {
    [Fact]
    public void Todo() {
      var context = EntityFrameworkMockHelper.GetMockContext<SchoolDbContext>();
      var controller = new StudentsController(context.Object);

      var result = controller.GetResource(Guid.NewGuid());
    }
  }
