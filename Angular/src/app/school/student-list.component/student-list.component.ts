...
import {StudentState, selectAll} from '../state/student.reducer';
import {GetStudents, RemoveStudent} from '../state/student.actions';
...
export class StudentListComponent implements OnInit {
    displayedColumns = ['edit', 'userId', 'givenName', 'surname', 'delete'];
    ...
    ngOnInit() {
        ...
        this.dataSource = new StudentDataSource(this.students, this.sort);
        /*
    ...
    onDeleteStudent(id: string): void {
        this.store.dispatch(new RemoveStudent(id));
    }
}
